...
const Pricing = () => {
  ...
  const getpricingplan = async () => {
    ...
    var res = await axios.get("https://spotify-backend-blue.vercel.app/pricing/getAll");
    res = res.data;
  ...
  const handlepayment = async (plan) => {
    ...
    var res= await axios.post("https://spotify-backend-blue.vercel.app/payment/createOrder", {
    ...
    var  options = {
      ...
      "handler": async function (response) {
        ...
        var res= await axios.post("https://spotify-backend-blue.vercel.app/payment/create", {
