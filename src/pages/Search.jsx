...
const Search = () => {
    ...
    return (<>
        ...
        <div className="w-100 text-white container-fluid" >
                ...
                <div className="mx-1 justify-content-between gap-2 text-white rounded scroll" style={{ backgroundColor: "#121212", height: "78vh" }}>

                    <div className="d-flex column-gap-3 btn-div py-3 px-5 sticky-top "  style={{ backgroundColor: "#121212",}}>
