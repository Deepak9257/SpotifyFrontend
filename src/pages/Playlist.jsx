...
const Playlist = () => {
    ...
    const getAllPlaylist = async () => {
        ...
        var res = await axios.get("http://spotifybackend.ap-1.evennode.com//playlist/getById/" + id)
        res = res.data
    ...
    const getSong = async () => {
        const id = window.location.pathname.split('/playlist/')[1]
        var res = await axios.get("http://spotifybackend.ap-1.evennode.com//playlistSong/getAllSongs/" + id)
        res = res.data
        console.log(res.data);
        setSong(res.data)
    ...
    const UpdateByID = async (id) => {
        var res = await axios.put("http://spotifybackend.ap-1.evennode.com//playlist/update/" + id, {
            name, image, status
        })
        res = res.data
        console.log(res.data)
    ...
    const handleDelete = async (id) => {
        ...
        var res = await axios.delete("http://spotifybackend.ap-1.evennode.com//playlist/deleteById/" + id)
        res = res.data
        navigate("/")
