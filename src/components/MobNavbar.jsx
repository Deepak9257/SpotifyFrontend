...
const MobNavbar = () => {
    ...
    return (<>
        ...
        <div className="mob-navbar">
            ...
            <Link to={"/search"} className="text-decoration-none">  <div className={`${path === "/search" ? "text-white" : '' }`}> {path === "/search" ? <SearchIcon2 fill={'white'}  height="30" /> : <SearchIcon fill={'white'}  height="28" />} Search</div>  </Link>
