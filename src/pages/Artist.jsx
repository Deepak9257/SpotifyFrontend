...
const Artist = ({ userId }) => {
    ...
    return (
        <>
            ...
            <div className="w-100 text-white h-100 mob-margin position-relative">

             <div className="text-white mob-artist-name">
                {Artist && Artist.name}
            </div>
                ...
                {Artist && (
                    <ScrollBar customClassName={"rounded"} height={"80vh"}>
                        <div
                            id="rytBar"
                            className="gap-2 text-white rounded rounded-0 "
                            style={{ backgroundColor: "#121212" }}
                        >
                            <div className="artist-header mob-artist-header">
                                <div>
                                    <img
                                        src={Artist.image}
                                        alt="artist pic"
                                        className="object-fit-cover rounded-circle mob-artist-img"
                                        style={{
                            ...
                            <div className="controls artist-play-btn">
                                {userId ? (
                                    // display when logined
                                    <div
                                        className={`play-button ${playId === Artist._id &&
                                            currentSong?.artist?._id === Artist._id &&
                                            isPlaying
                                            ? "opacity-100 translate-0"
                                            : ""
                                            }`}
                                        onClick={() => {
                                            handleSongChange(Artist._id), setPlayId(Artist._id);
                                        }}
                                    >
                                        {playId === Artist._id &&
                                            currentSong?.artist?._id === Artist._id &&
                            ...
                            <div className="table-container mob-p-1">
                                <div className="">

                                    <span className="fs-2 fw-bold">Popular</span>{" "}
                                </div>
                                <table className="mob-d-none">
                                    <thead>
                                        <tr className="">
                                        ...
                                        {songs &&
                                            songs.map((song, index) => (
                                                ...
                                                >
                                                    ...
                                                    <td className=""> {song?.album?.name}</td>
                                            ...
                                            <div key={index} className="mob-song-div" >
                                                ...
                                                >
                                                    ...
                                                    <div className="d-flex col align-items-center">
                                                        ...
                                                        <div className="px-2">
                                                            <span className={` song-info ${audioId === song?._id ? "text-green" : ""}`}> {song.name} </span>
            ...
            {oneArtist && (
                <div
                    ...
                    aria-hidden="true"
                >
                    <div className="custom-modal-dialog modal-dialog  modal-dialog-centered">
                        <div className=" modal-content custom-modal-content rounded">
                            <div className="custom-modal-body modal-body p-5 d-flex gap-5 ">
                                ...
                                <div className="text-white text-center py-5 col ">
                                    ...
                                    <a href="/signup">
                                        <div className="py-3 px-4 text-black fw-bold btn rounded-pill text-black nav-login-btn green">
                                            Sign up for free
                                        </div>
                                    </a>
                            ...
                            <div className="text-center d-flex justify-content-center">
                                <div
                                    ...
                                    className="text-center p-0 close fs-5 fw-bold"
                                >
                                    Close
                                </div>
                            </div>
